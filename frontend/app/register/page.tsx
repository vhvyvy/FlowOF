    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-1">Создать аккаунт агентства</p>
        </div>

        <div className="bg-slate-800/60 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
          <h2 className="text-lg font-semibold text-slate-100 mb-6">Регистрация</h2>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-medium text-slate-400 mb-1.5">Название агентства</label>
              <Input
                value={agencyName}
            ...
            <div>
              <label className="block text-xs font-medium text-slate-400 mb-1.5">Пароль (мин. 8 символов)</label>
              <Input
                type="password"
                value={password}
